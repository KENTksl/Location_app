    ...
    try {
      ...
      if (friendsSnap.exists && friendsSnap.value is Map) {
        ...
        for (final friendId in friends.keys) {
          ...
          final chatRef = FirebaseDatabase.instance.ref('chats/$chatId/messages');
              ...
              ? Center(
                  child: Column(
                    ...
                    children: const [
                      ...
                      SizedBox(height: 16),
                      Text('Chưa có cuộc trò chuyện nào', style: TextStyle(fontSize: 18)),
                      SizedBox(height: 8),
                      Text('Hãy kết bạn và bắt đầu trò chuyện!', style: TextStyle(color: Colors.blueGrey)),
                    ],
                  ),
                )
              : ListView.separated(
                    ...
                    return Card(
                      ...
                      child: ListTile(
                        ...
                        leading: CircleAvatar(
                          ...
                          child: Text(
                            (chat['friendEmail'] != null && chat['friendEmail'].isNotEmpty)
