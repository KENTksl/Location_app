  ...
  Future<void> _startLocationTracking() async {
    ...
    final LocationSettings settings = Platform.isAndroid
        ? AndroidSettings(
            ...
            distanceFilter: common.distanceFilter,
            intervalDuration: const Duration(seconds: 3),
            foregroundNotificationConfig: const ForegroundNotificationConfig(
              notificationText: 'Ứng dụng đang theo dõi vị trí của bạn',
              notificationTitle: 'Chia sẻ vị trí',
            ),
          )
        : AppleSettings(
            accuracy: common.accuracy,
    ...
    _backgroundTimer?.cancel();
    _backgroundTimer = Timer.periodic(const Duration(seconds: 10), (
      timer,
    ) async {
      try {
